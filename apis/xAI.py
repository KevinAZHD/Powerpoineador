...
class GrokAPIKeyWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(obtener_traduccion('xai_api_config_window', self.current_language))
    ...
    def setup_ui(self):
        ...
        layout.addWidget(QLabel(obtener_traduccion('xai_api_key_prompt', self.current_language)))
    ...
    def validate_api(self):
        ...
        if not api_key.startswith("xai-"):
            self.show_status(obtener_traduccion('invalid_key_format', self.current_language))
            self.status_label.setStyleSheet("color: red; qproperty-alignment: AlignCenter;")
            return
